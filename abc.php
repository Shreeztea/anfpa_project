          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="fixed.php">Fixed Deposit</a>
                                <a class="dropdown-item" href="#"><span class="eng">News 1</span>
                  <span class="nep"></span>
                </a>
                                <a class="dropdown-item" href="#"><span class="eng">News 2</span>
                  <span class="nep"></span>
                </a>
                                <a class="dropdown-item" href="#"><span class="eng">Hermione Granger</span>
                  <span class="nep"></span>
                </a>
                                <a class="dropdown-item" href="#"><span class="eng">Harry Potter</span>
                  <span class="nep">दनाना</span>
                </a>
                                <a class="dropdown-item" href="#"><span class="eng">Current</span>
                  <span class="nep">चल्ती</span>
                </a>
                              </div>
          </li>
          <li class="nav-item dropdown">
